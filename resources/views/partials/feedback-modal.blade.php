...
@if(filled($feedbackMessage))
  @if(($successAsToast ?? false) && $feedbackType === 'success')
    <div class="alert ok toast-flash" data-feedback-toast role="status">{{ $feedbackMessage }}</div>
    <script>
    (function () {
      var toast = document.querySelector('[data-feedback-toast]');
      if (!toast) return;
