...
use App\Http\Controllers\Admin\PackageClosingReportController;
use App\Http\Controllers\Admin\PriceSyncController;
use App\Http\Controllers\Admin\PriceSyncScheduleController;
...
use App\Http\Controllers\PriceListController as StorefrontPriceListController;
...
Route::get('/daftar-harga', [StorefrontPriceListController::class, 'index'])->name('price-list');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(AdminAuthenticate::class)->group(function () {
        ...
        Route::middleware('can:manage-catalog')->group(function () {
            ...
            Route::get('price-sync/report', [PriceSyncController::class, 'report'])->name('price-sync.report');
            Route::get('price-sync/schedule', [PriceSyncScheduleController::class, 'edit'])->name('price-sync.schedule.edit');
            Route::put('price-sync/schedule', [PriceSyncScheduleController::class, 'update'])->name('price-sync.schedule.update');
            ...
            Route::get('reports/closing', [PackageClosingReportController::class, 'index'])->name('reports.closing');
